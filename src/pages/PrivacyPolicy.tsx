    ...
    return (
        <div className="container main-content-width">
            ...
            <p>
                ...
                This Privacy Policy explains how we collect, use, and protect your information when you use our application (the "App") and interact with our services. By accessing or using the App, you agree to the collection and use of your data in accordance with this policy.<br /><br />

                <strong>1. Information We Collect</strong><br />
                We collect and store data in your browser's local storage to improve your experience. The following data may be stored:<br />
                ...
                <strong>4. How You Can Manage Your Data</strong><br />
                You have control over the data stored in your local storage:<br />
                - <strong>Clear Local Storage:</strong> You can clear the data stored in your local storage through your browser settings or within the app.<br /><br />

                <strong>5. Third-Party Services</strong><br />
                - Our App may use third-party services such as APIs (e.g., NASA NEO API) for the functionality of the dashboard. These third-party services may have their own terms of services regarding data, and we encourage you to review their privacy policies.<br />
                - Our app may contain a link to GitHub profiles, including the one where you can view the source code. This link is provided only for transparency and for users to engage with our code, and it does not imply any affiliation with GitHub.<br /><br />
