...
const About = () => {
    return (
        <div className="container main-content-width">
            ...
            <h2>Contact</h2>
            <p>If you have any questions or suggestions, feel free to reach out via email or visit my <a href="https://github.com/soumyargha-sinha/" target="_blank" rel="noopener noreferrer">GitHub</a>.</p>
        </div>
    )
}
